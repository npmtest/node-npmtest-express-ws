...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-express-ws/node_modules/express-ws/lib/websocket-url.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-express-ws/node_modules/express-ws/lib/websocket-url.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-express-ws/node_modules/express-ws/lib/</a> &#187; websocket-url.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >function websocketUrl(url) {</span>
<span class="cstat-no" title="statement not covered" >  if (url.indexOf('?') !== -1) {</span>
<span class="cstat-no" title="statement not covered" >    var _url$split = url.split('?'),</span>
        _url$split2 = _slicedToArray(_url$split, 2),
        baseUrl = _url$split2[0],
        query = _url$split2[1];
&nbsp;
<span class="cstat-no" title="statement not covered" >    return (0, _trailingSlash2.default)(baseUrl) + '.websocket?' + query;</span>
  }
<span class="cstat-no" title="statement not covered" >  return (0, _trailingSlash2.default)(url) + '.websocket';</span>
}
&nbsp;</pre></td></tr>
</table></pre>
</div>
